package net.synchlabs.backrooms.world.biome;
...
import net.synchlabs.backrooms.init.BackroomsEarlyRisers;
import net.synchlabs.backrooms.init.BackroomsFeatures;
import net.synchlabs.backrooms.util.Color;
...
public class RedRoomsBiome {
	...
	public static Biome create() {
		...
		generationSettings.feature(Feature.RAW_GENERATION, BackroomsFeatures.LEVEL0_RED_WALLPAPER_FILLER);
		generationSettings.feature(Feature.RAW_GENERATION, BackroomsFeatures.LEVEL0_DOOR_CARVER);

		BiomeEffects.Builder biomeEffects = new BiomeEffects.Builder();
		biomeEffects.skyColor(Color.of(51, 7, 7));
