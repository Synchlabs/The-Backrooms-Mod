...
import net.synchlabs.backrooms.world.biome.Level0Biome;
import net.minecraft.util.Identifier;
import net.minecraft.util.registry.BuiltinRegistries;
import net.minecraft.util.registry.Registry;
import net.minecraft.util.registry.RegistryKey;
import net.minecraft.world.biome.Biome;
import net.synchlabs.backrooms.world.biome.RedRoomsBiome;
...
public class BackroomsBiomes {
	...
	public static void init() {
		...
		Level0.NOISE_POINTS.put(REDROOMS_LEVEL0, new Biome.MixedNoisePoint(0.0F, 0.0F, 0.0F, 0.0F, 0.0F));
	}
